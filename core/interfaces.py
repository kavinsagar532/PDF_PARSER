...
class Nameable(Protocol):
    """Protocol for components that expose a name."""
...
class Identifiable(Protocol):
    """Protocol for components that expose a stable identifier."""
...
class ResettableInterface(ABC):
    """Interface for components that can reset internal state."""
...
class DescribableInterface(ABC):
    """Interface for components that provide descriptions."""
