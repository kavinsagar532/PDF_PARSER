...
class ComponentStats:
    """Immutable data container for component stats snapshots."""
...
class ResettableMixin(ABC):
    """Mixin for components that can reset internal state."""

    @abstractmethod
    def reset(self) -> None:
        """Reset internal state for the component."""
        raise NotImplementedError


class DescribableMixin(ABC):
    """Mixin for components that provide a description."""
